/**
 * Dev/E2E-only registry that publishes the reference directions a scene actually
 * drew, keyed by the spacecraft they were drawn at.
 *
 * Same shape as {@link registerSatWorldQuat}: E2E reads
 * `window.__debug_get_direction_vectors(id)` to assert an arrow without reading
